...
* `io.company.app.frontend.routing` - all the code related to the frontend application routing.
* `io.company.app.frontend.services` - the business logic of the client application.
* `io.company.app.frontend.views` - the code describing views and their behaviour.

The root package (`io.company.app.frontend`) also contains `JSLauncher` and `ApplicationContext`. The former 
